class funcionVM:
	def __init__(self, nombre, tipo, varEnt, varDec, varCuadrado, varRect, varCirc, varLin, varEstr, varBool, varEntTemp, varDecTemp, varCuadradoTemp, varRectTemp, varCircTemp, varLinTemp, varEstrTemp, varBoolTemp, cuadruploInicial, cantidadParam):
		self.nombre = nombre
		self.tipo = tipo
		self.varEnt = varEnt
		self.varDec = varDec
